...
export function HeroSection() {
  const searchOptions = ["Courses", "Trainers", "Certificates"];
  const [searchString, setSearchString] = useState(searchOptions[0]); // Default to the first option
      ...
      <div className="relative px-4 py-24 mx-auto max-w-7xl">
        <div className="max-w-3xl mx-auto text-center text-white">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">
            The #1 site for lifelong learners <br /> & experienced trainers.<sup>*</sup>
          </h1>
          ...
          <div className="relative mt-8">
            <div className="flex items-center bg-white rounded-full shadow-lg">
              <input
                ...
                onChange={(e) => setSearchString(e.target.value)} // Update search string dynamically
              />
