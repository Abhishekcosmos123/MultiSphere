                ...
                <Card className="bg-white shadow-xl">
                    ...
                    <CardContent>
                        {!isOtpVerification && (
                            <>
                                <div className="flex border-b border-gray-200 mb-6">
                                    <button
                                        className={`flex-1 py-2 text-center ${loginMethod === 'email' ? 'border-b-2 border-red-600 text-red-600' : 'text-gray-500'}`}
                                        onClick={() => setLoginMethod('email')}
                                    >
                                        <FaEnvelope className="inline mr-2" /> Email
                                    </button>
                                    <button
                                        className={`flex-1 py-2 text-center ${loginMethod === 'phone' ? 'border-b-2 border-red-600 text-red-600' : 'text-gray-500'}`}
                        ...
                        {isOtpVerification ? (
                            <OTPValidation 
                                email={phone} 
                                onVerify={() => router.push("/super-admin/dashboard")}
                                role="super-admin"
                            />
                        ) : (
